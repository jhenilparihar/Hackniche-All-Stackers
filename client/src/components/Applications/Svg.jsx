...
export const Edit = () => (
  <span role="img" aria-label="edit" tabindex="-1" class="icon-edit">
    <svg
      viewBox="64 64 896 896"
      focusable="false"
      data-icon="edit"
...
export const Delete = () => (
  <span role="img" aria-label="delete" class="icon-delete">
    <svg
      viewBox="64 64 896 896"
      focusable="false"
      data-icon="delete"
...
export const Confirm = () => (
  <span role="img" aria-label="check-circle" class="icon-edit">
    <svg
      viewBox="64 64 896 896"
      focusable="false"
